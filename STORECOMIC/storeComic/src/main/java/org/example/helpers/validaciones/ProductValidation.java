...
public class ProductValidation {
    ...
    public boolean priceValidation(Integer price) throws Exception {
        ...
        if (price < 0) {
            System.out.println("Error! has ingresado un valor del producto Negativo.");
        }
    ...
    public boolean descriptionValidation(String description) throws Exception {
        ...
        if (coincidencia != true) {
            throw new Exception("Error! solo podras agregar 50 caracteres a la descripcion de este producto.");
        }
